 ...
 */
final class Version20230622081422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profil (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(255) NOT NULL, reseausocial VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE personne ADD profil_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL, DROP travail');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD travail VARCHAR(70) DEFAULT NULL, DROP profil_id, DROP job_id');
    }
}
